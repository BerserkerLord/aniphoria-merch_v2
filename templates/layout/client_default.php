				...
				<div class="col-lg-12">
					<div class="logo-carousel-inner">
						<div class="single-logo-item">
                            //$this -> Html -> image('/webroot/template_assets/img/company-logos/1.png')
						</div>
						<div class="single-logo-item">
                            //$this -> Html -> image('/webroot/template_assets/img/company-logos/2.png')
						</div>
						<div class="single-logo-item">
                            //$this -> Html -> image('/webroot/template_assets/img/company-logos/3.png')
						</div>
						<div class="single-logo-item">
                            //$this -> Html -> image('/webroot/template_assets/img/company-logos/4.png')
						</div>
						<div class="single-logo-item">
                            //$this -> Html -> image('/webroot/template_assets/img/company-logos/5.png')
						</div>
					</div>
				</div>
			</div>
