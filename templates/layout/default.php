...
<body>
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled components">
            <li><a href="#"><i class="fas fa-user-tag pr-2"></i>Clients</a></li>
            <li><?= $this -> Html -> link('<i class="fas fa-book pr-2"></i>Categories', ['_name' => 'viewCategories'], ['escape' => false]) ?></li>
            <li><?= $this -> Html -> link('<i class="fas fa-shopping-basket pr-2"></i>Merchandising', ['_name' => 'viewMerchandising'], ['escape' => false]) ?></li>
            <li><a href="#"><i class="fas fa-file-invoice-dollar pr-2"></i>Buying Orders</a></li>
            <li><?= $this -> Html -> link('<i class="fas fa-truck-moving pr-2"></i>Manufacturers', ['_name' => 'viewManufacturers'], ['escape' => false]) ?></li>
            <li><a href="#"><i class="fas fa-tag pr-2"></i>Discount coupons</a></li>
            <li><a href="#"><i class="fas fa-credit-card pr-2"></i>Paying Methods</a></li>
            <li><a href="#"><i class="fas fa-running pr-2"></i>Log Out</a></li>
        </ul>
    </nav>
    <main class="main">
